"""
Django settings for restless_flower_41432 project.
...
ROOT_URLCONF = 'restless_flower_41432.urls'
...
WSGI_APPLICATION = 'restless_flower_41432.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_flower_41432 API",
    "DESCRIPTION": "API documentation for restless_flower_41432 App",
    "VERSION": "v1",
}
